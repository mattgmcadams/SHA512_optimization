...
; 0x0912 -- 0x09FF
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.define t1h		0x08E1		;temp1
.define T1L		0x08E2		;temp1 lower
.define T2H		0x08E3		;temp2
.define T2L		0x08E4		;temp2 lower
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	ldi		r7, 0		;the loop count
	
sch4:		
																	;stm		t3, r7		                ; 8
	ldi		r3, 0	        		; 8								;
	ldix	r0, r3, wve				;r0=e higher					;ldm 	r0, wve						;r0 & r1 = e
	ldix 	r1, r3, wvel			;r1=e lower						;ldm 	r1, wvel
	sum1	r0, r1					;r0 & r1=sum1(e)				;
	
	ldix	r4, r3, wvh				;r4=h							;ldm 	r2, wvf						;r2 & r3 = f
	ldix 	r5, r3, wvhl			;r5=h lower						;ldm 	r3, wvfl
	add64   r0, r1, r4, r5			;r0 & r1 = h+sum1(e)			;
	stm 	t1h, r0					;T1 = h+sum1(e)					;ldm 	r4, wvg						;r4 & r5 = g
	stm 	T1l, r1													;ldm 	r5, wvgl		
	
	ldm 	r0, wve					;r0 & r1 = e					;
	ldm 	r1, wvel												;ldm	r6, wvh						;r4=h
	
	ldm 	r2, wvf					;r2 & r3 = f					;ldm 	r7, wvhl						;r5=h lower
	ldm 	r3, wvfl				;				        
	
	ldm 	r4, wvg					;r4 & r5 = g					;t1a	r0, r1, r2, r3, r4, r5, r6, r7
	ldm 	r5, wvgl				;
	
	ch   	r0, r1, r2, r3, r4, r5	;r0 & r1 = ch(e,f,g)			;ldm	r7, t3
	ldm 	r4, t1h					;r4 & r5 = h+sum1(e)			;
	ldm 	r5, T1l													;ldix	r2, r7, k512					;r4 & r5 = K[i]
	
	add64   r0, r1, r4, r5		;r0 & r1 = ch(e,f,g) + h+sum1(e)	;adi 	r7, 1
	ldix	r4, r6, k512			;r4 & r5 = K[i]					;ldix 	r3, r7, k512
	adi 	r6, 1													;adi	r7, 0xffff
	ldix 	r5, r6, k512											;ldix	r4, r7, w80						;r4 & r5 = W
	add64   r0, r1, r4, r5		;r0 & r1 =h+sum1(e)+Ch(e,f,g)+K		;adi 	r7, 1
	ldix	r4, r7, w80				;r4 & r5 = W					;ldix 	r5, r7, w80
	adi 	r7, 1													;adi	r7, 0xffff
	ldix 	r5, r7, w80				;
	add64   r0, r1, r4, r5		;r0 & r1 =h+sum1(e)+Ch(e,f,g)+K+W	;t1b	r0, r1, r2, r3, r4, r5		;r0&r1 = h + sum1(e) + ch(e,f,g)
	stm 	t1h, r0					;T1=h+sum1(e)+Ch(e,f,g)+K+W		;
	stm 	T1l, r1													;stm	t1h, r0
	ldm		r0, wva					;r0=a							;stm	t1l, r1
	ldm 	r1, wval				;r1=a lower						;
	sum0    r0, r1					;r0 & r1 = sum(a)				;ldm	r0, wva					;r0=a
	stm 	t3, r0					;T3 = sum0(a)					;ldm 	r1, wval						;r1=a lower
	stm 	T3l, r1					;
	ldm	r0, wva						;r0=a							;ldm 	r2, wvb						;r2=b
	ldm 	r1, wval				;r1=a lower						;ldm 	r3, wvbl						;r3=b lower
	ldm 	r2, wvb					;r2=b							;
	ldm 	r3, wvbl				;r3=b lower						;ldm 	r4, wvc						;r4=c
	ldm 	r4, wvc					;r4=c							;ldm 	r5, wvcl						;r5=c lower
	ldm 	r5, wvcl				;r5=c lower						;
	maj 	r0, r1, r2, r3, r4, r5	;r0 & r1=Maj(a,b,c)				;t2		r0, r1, r2, r3, r4, r5			; r0&r1 = sum0(a) + maj(a,b,c)
	ldm 	r4, T3					;r4 & r5 = sum(a)				;
	ldm 	r5, T3l													;stm 	T2H, r0							;T2 = sum0(a)+Maj(a,b,c)
	add64   r0, r1, r4, r5			;r0 & r1 =sum0(a)+Maj(a,b,c)	;stm	T2L, r1	
	ldi	r3, 0						;
	stm 	T3, r0					;T3 = sum0(a)+Maj(a,b,c)		;ldm	r0, wvg					;h <= g
	stm	T3l, r1														;ldm 	r1, wvgl
	ldix	r0, r3, wvg				;h <= g			;
	ldix 	r1, r3, wvgl											;stm 	wvh, r0
	stm 	wvh, r0													;stm 	wvhl, r1
	stm 	wvhl, r1				;
	ldix	r0, r3, wvf				;g <= f							;ldm	r0, wvf					;g <= f
	ldix 	r1, r3, wvfl											;ldm 	r1, wvfl
	stm		wvg, r0					;
	stm 	wvgl, r1;												;stm	wvg, r0		
	ldix	r0, r3, wve				;f <= e							;stm 	wvgl, r1;
	ldix 	r1, r3, wvel			;
	stm		wvf, r0													;ldm	r0, wve						;f <= e
	stm 	wvfl, r1												;ldm 	r1, wvel
	ldix	r0, r3, wvd												;
	ldix 	r1, r3, wvdl											;stm	wvf, r0
	ldix	r4, r3, t1h												;stm 	wvfl, r1
	ldix 	r5, r3, T1l				;
	add64   r0, r1, r4, r5			;e <= d + t1h					;ldm	r0, wvd
	stm		wve, r0													;ldm 	r1, wvdl
	stm 	wvel, r1				;
	ldix	r0, r3, wvc				;d <= c			;
	ldix 	r1, r3, wvcl			;
	stm		wvd, r0													;ldm	r4, t1h
	stm 	wvdl, r1												;ldm 	r5, T1l
	ldix	r0, r3, wvb				;c <= b			;
	ldix 	r1, r3, wvbl											;add64   r0, r1, r4, r5					;e <= d + T1
	stm		wvc, r0					;
	stm 	wvcl, r1												;stm	wve, r0
	ldix	r0, r3, wva				;b <= a							;stm 	wvel, r1
	ldix 	r1, r3, wval			;
	stm		wvb, r0													;ldm	r0, wvc						;d <= c
	stm 	wvbl, r1												;ldm 	r1, wvcl
	ldix  	r0, r3, t1h												;
	ldix 	r1, r3, T1l												;stm	wvd, r0
	ldix 	r4, r3, T3												;stm 	wvdl, r1
	ldix 	r5, r3, T3l				;
	add64   r0, r1, r4, r5			;a <= T1 + T3					;ldm 	r0, wvb						;c <= b
	stm		wva, r0													;ldm  	r1, wvbl
	stm 	wval, r1				;
	adi		r6, 1					;inc pointer to K				;stm	wvc, r0
	adi		r7, 1					;inc pointer to W				;stm 	wvcl, r1
	cmpi 	r7, 160					;
	jnz	sch4														;ldm 	r0, wva						;b <= a
																	;ldm  	r1, wval
																	;
																	;stm	wvb, r0	
																	;stm 	wvbl, r1
