...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	stm	wvb, r0
	stm	wvbl, r1
	SUMA	r0, r1, r2, r3, r4, r5

	;stm 	T3, r0							;T2 = sum0(a)+Maj(a,b,c)
	;stm	T3l, r1
	ldi	r3, 0
...
sch5:
	...
	adi 	r2, 0xFFFF 						;reset r3
	stix	r2, r0, h0						;r3 (h[i]) = w[i] + h[i]
	inc 	r2
	stix 	r2, r1, h0
	inc	r2						;wv pointer++
	cmpi 	r2, 16
