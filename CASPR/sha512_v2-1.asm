...
;  wvah, wvbh, ..., wvhh = working variables a to h
...
sch4:		
	...
	ldm 	r4, T3h				;r4 & r5 = sum(a)
	ldm 	r5, T3l
	add64   r0, r1, r4, r5			;r0 & r1 =sum0(a)+Maj(a,b,c)
	ldi	r3, 0
	stm 	T3h, r0				;T3 = sum0(a)+Maj(a,b,c)
	stm		T3l, r1
	ldix	r0, r3, wvgh			;h <= g
	ldix 	r1, r3, wvgl
	stm 	wvhh, r0
