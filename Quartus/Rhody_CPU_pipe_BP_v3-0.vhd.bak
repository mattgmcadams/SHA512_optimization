...
signal operand0, operand1, ALU_out, temp32a, temp32b : std_logic_vector(31 downto 0);
signal realX, realY, realZ, t1temp : std_logic_vector(63 downto 0);
...
constant T1A  : std_logic_vector(5 downto 0) := "001110";
constant T1B  : std_logic_vector(5 downto 0) := "001111";
...
constant T2   : std_logic_vector(5 downto 0) := "011000";
--	           : std_logic_vector(5 downto 0) := "011001";
...
--	           : std_logic_vector(5 downto 0) := "101100";
--	           : std_logic_vector(5 downto 0) := "101101";
--	           : std_logic_vector(5 downto 0) := "101110";
--	           : std_logic_vector(5 downto 0) := "101111";
...
--	           : std_logic_vector(5 downto 0) := "110110";
constant INC  : std_logic_vector(5 downto 0) := "110111";
constant PUSH : std_logic_vector(5 downto 0) := "111000";
constant POP  : std_logic_vector(5 downto 0) := "111001";
constant INC2 : std_logic_vector(5 downto 0) := "111010";
constant INC3 : std_logic_vector(5 downto 0) := "111011";
...
--				realX <=
--					std_logic_vector(register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RZ2)))) xor
--					std_logic_vector(not register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RB2))))
--					& std_logic_vector(register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RA2))))xor
--					std_logic_vector(not register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RC2))));
--				realX <=
...
--					((not (std_logic_vector(unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2))))))) and 
...
--				realX <=
--					std_logic_vector(unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2)))) and 
--										  unsigned(register_file(to_integer(unsigned(RZ2)))) & unsigned(register_file(to_integer(unsigned(RA2))))) xor
--					std_logic_vector(unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2)))) and 
--										  unsigned(register_file(to_integer(unsigned(RB2)))) & unsigned(register_file(to_integer(unsigned(RC2))))) xor
--					std_logic_vector(unsigned(register_file(to_integer(unsigned(RZ2)))) & unsigned(register_file(to_integer(unsigned(RA2)))) and 
--									     unsigned(register_file(to_integer(unsigned(RB2)))) & unsigned(register_file(to_integer(unsigned(RC2)))));
				...
				realX <=std_logic_vector((unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2))))) + 
				(unsigned(register_file(to_integer(unsigned(RZ2)))) & unsigned(register_file(to_integer(unsigned(RA2))))));
			
			elsif (Opcode2=T1A) then
				register_file(to_integer(unsigned(RX2))) <= std_logic_vector(
					unsigned((register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RZ2))))xor
					(not register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RB2))))) +
					unsigned(std_logic_vector(    register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RZ2)))) xor
								std_logic_vector(not register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RB2)))))
					);
								
				register_file(to_integer(unsigned(RY2))) <= std_logic_vector(
					unsigned((register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RA2))))xor
					    (not register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RC2))))) +
					unsigned(std_logic_vector(    register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RA2)))) xor
					         std_logic_vector(not register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RC2)))))
					);
			
--				realX <= std_logic_vector(
--					unsigned(std_logic_vector(    register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RZ2)))) xor
--								std_logic_vector(not register_file(to_integer(unsigned(RX2))) and register_file(to_integer(unsigned(RB2)))))
--							 & std_logic_vector(    register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RA2)))) xor
--								std_logic_vector(not register_file(to_integer(unsigned(RY2))) and register_file(to_integer(unsigned(RC2)))))
...
--								std_logic_vector(rotate_right(unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2)))), 18)) xor
--								std_logic_vector(rotate_right(unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2)))), 41))) + 
--					(unsigned(register_file(to_integer(unsigned(RD2)))) & unsigned(register_file(to_integer(unsigned(RE2)))))
--					);
...
--					   wvh = d e
			...
			elsif (Opcode2 = T1B) then
				realX <= 
					std_logic_vector(unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2)))) 
										+ unsigned(register_file(to_integer(unsigned(RZ2)))) & unsigned(register_file(to_integer(unsigned(RA2)))) 
										+ unsigned(register_file(to_integer(unsigned(RB2)))) & unsigned(register_file(to_integer(unsigned(RC2)))))(0 to 63);
			   ...
			   -- input = rx ry
				...
				realX <=	std_logic_vector(			-- sum0(a) + maj(a,b,c)
					unsigned(std_logic_vector(rotate_right((unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2))))), 14)) xor
								std_logic_vector(rotate_right((unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2))))), 18)) xor
								std_logic_vector(rotate_right((unsigned(register_file(to_integer(unsigned(RX2)))) & unsigned(register_file(to_integer(unsigned(RY2))))), 41)))
		...
		when S2 =>
			if (Opcode2=ADD or Opcode2=SUB or Opcode2=IROR or Opcode2=IAND or
				...
				MDR_out <= register_file(to_integer(unsigned(RX2)));
						...
						Opcode2=SUM0 or Opcode2=SUM1 or Opcode2=ADD64 or
						Opcode2 = T1A or Opcode2=T1B or Opcode2=T2) then
				register_file(to_integer(unsigned(RX2))) <= realX(63 downto 32);
				register_file(to_integer(unsigned(RY2))) <= realX(31 downto 0);
--			elsif (Opcode2=T1A) then
--				register_file(to_integer(unsigned(RD2))) <= realX(63 downto 32);
--				register_file(to_integer(unsigned(RE2))) <= realX(31 downto 0);
			end if;
			stage2 <= S1;
		when others =>
			null;
